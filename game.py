...
color_cycle=cycle(['light blue', 'light pink','light green','red','blue' ,'green','black'])
egg_width = 40
egg_height = 50
egg_score= 10
egg_speed=500
...
catcher = c.create_arc(catcher_start_x, catcher_start_y, catcher_start_x2, catcher_start_y2,start=200,extent=140,style='arc',outline=catcher_color)
